...
<div class="row">
	...
	<div class="col-xs-12 text-center">
		...
		@if(!empty($receipt_details->sub_heading_line1))
			<br/>{{ $receipt_details->sub_heading_line1 }}
		@endif
				...
				@forelse($receipt_details->lines as $line)
					<tr>
						<td style="word-break: break-all;">
                            ...
                            <br/>
                            {{$line['quantity']}} {{$line['units']}} X {{$line['unit_price_inc_tax']}}
                        </td>
						...
						@foreach($line['modifiers'] as $modifier)
							<tr>
								<td>
		                            ...
		                            <br/>
		                             {{$modifier['quantity']}} {{$modifier['units']}} X {{$modifier['unit_price_inc_tax']}}
		                        </td>
	...
	<div class="col-xs-12">
      	<table class="table">
			<tbody>
				...
				<tr>
					<th>
						<h3>{!! $receipt_details->total_label !!}</h3>
					</th>
					<td>
						<h3>{{$receipt_details->total}}</h3>
					</td>
				</tr>
			</tbody>
    	</table>
