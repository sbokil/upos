        ...
        <div class="checkbox">
            ...
            <label>
                <a class="terms_condition" data-toggle="modal" data-target="#tc_modal">
                    <?php echo app('translator')->getFromJson('lang_v1.accept_terms_and_conditions'); ?>
                </a>
            </label>
        </div>
        <?php echo $__env->make('business.partials.terms_conditions', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
</div>
<div class="clearfix"></div>
</fieldset>