...
<div class="login-form col-md-12 right-col-content-register">
    
    <p class="form-header"><?php echo app('translator')->getFromJson('business.register_and_get_started_in_minutes'); ?></p>
    <?php echo Form::open(['url' => route('business.postRegister'), 'method' => 'post', 
                            'id' => 'business_register_form','files' => true ]); ?>

        <?php echo $__env->make('business.partials.register_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
