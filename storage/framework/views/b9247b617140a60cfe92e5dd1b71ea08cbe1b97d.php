    ...
    <div class="row">
      <h3 class="text-center"><?php echo e(config('app.name', 'POS'), false); ?> Installation <small>Step 1 of 3</small></h3>
        ...
        <div class="col-md-8 col-md-offset-2">
          <hr/>
          <?php echo $__env->make('install.partials.nav', ['active' => 'install'], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <?php echo $__env->make('install.partials.e_license', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
