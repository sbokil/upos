...
<script src="<?php echo e(asset('AdminLTE/plugins/pace/pace.min.js?v=' . $asset_v), false); ?>"></script>
...
<!-- Select2 -->
<script src="<?php echo e(asset('AdminLTE/plugins/select2/select2.full.min.js?v=' . $asset_v), false); ?>"></script>
...
<script src="<?php echo e(asset('AdminLTE/plugins/datepicker/bootstrap-datepicker.min.js?v=' . $asset_v), false); ?>"></script>
<!-- DataTables -->
<script src="<?php echo e(asset('AdminLTE/plugins/DataTables/datatables.min.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('AdminLTE/plugins/DataTables/pdfmake-0.1.32/pdfmake.min.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('AdminLTE/plugins/DataTables/pdfmake-0.1.32/vfs_fonts.js?v=' . $asset_v), false); ?>"></script>

<!-- jQuery Validator -->
<script src="<?php echo e(asset('js/jquery-validation-1.16.0/dist/jquery.validate.min.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('js/jquery-validation-1.16.0/dist/additional-methods.min.js?v=' . $asset_v), false); ?>"></script>
<?php
...
<!-- Toastr -->
<script src="<?php echo e(asset('plugins/toastr/toastr.min.js?v=' . $asset_v), false); ?>"></script>
<!-- Bootstrap file input -->
<script src="<?php echo e(asset('plugins/bootstrap-fileinput/fileinput.min.js?v=' . $asset_v), false); ?>"></script>
<!--accounting js-->
<script src="<?php echo e(asset('plugins/accounting.min.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('AdminLTE/plugins/daterangepicker/moment.min.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('AdminLTE/plugins/daterangepicker/daterangepicker.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('AdminLTE/plugins/ckeditor/ckeditor.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('plugins/sweetalert/sweetalert.min.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('plugins/bootstrap-tour/bootstrap-tour.min.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('plugins/printThis.js?v=' . $asset_v), false); ?>"></script>

<script src="<?php echo e(asset('plugins/screenfull.min.js?v=' . $asset_v), false); ?>""></script>

<script src="<?php echo e(asset('plugins/moment-timezone-with-data.min.js?v=' . $asset_v), false); ?>"></script>
<?php
...
<!-- Scripts -->
<script src="<?php echo e(asset('js/AdminLTE-app.js?v=' . $asset_v), false); ?>"></script>
...
<script src="<?php echo e(asset('plugins/calculator/calculator.js?v=' . $asset_v), false); ?>"></script>
<?php echo $__env->yieldContent('javascript'); ?>

<?php if(Module::has('Essentials')): ?>
  <?php if ($__env->exists('essentials::layouts.partials.footer_part')) echo $__env->make('essentials::layouts.partials.footer_part', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>